...
document.querySelector<HTMLDivElement>('#app')!.innerHTML = `
  ...
  <main>
    ...
    <section class="statement section">
      ...
      <div class="statement-card" aria-label="Business Analyst delivery principle">
        <p class="statement-eyebrow">How I create trust in delivery</p>
        <blockquote>
          Great BA work makes decisions easier for every team. I turn scattered inputs into clear requirements,
          signed-off UAT paths, CRM workflows, release notes, and KPI visibility.
        </blockquote>
        <div class="statement-points" aria-label="Business Analyst delivery points">
          <span>Discovery</span>
...
const tiltCards = Array.from(
  document.querySelectorAll<HTMLElement>(
    '.process-card, .shortlist-panel, .ask-panel, .statement-card, .artifact-grid article, .hire-grid article, .lab-grid article, .toolbox-grid article, .depth-card, .timeline-item',
  ),
);
